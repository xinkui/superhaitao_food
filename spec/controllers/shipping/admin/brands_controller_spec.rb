  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved brand as @brand" do
        ...
        post :create, {:brand => { "name_cn" => "invalid value" }}, valid_session
        assigns(:brand).should be_a_new(Brand)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested brand" do
        ...
        Brand.any_instance.should_receive(:update).with({ "name_cn" => "MyString" })
        put :update, {:id => brand.to_param, :brand => { "name_cn" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the brand as @brand" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Brand.any_instance.stub(:save).and_return(false)
        put :update, {:id => brand.to_param, :brand => { "name_cn" => "invalid value" }}, valid_session
        assigns(:brand).should eq(brand)
      end
