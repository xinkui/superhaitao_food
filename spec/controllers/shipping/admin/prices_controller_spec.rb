  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved price as @price" do
        ...
        post :create, {:price => { "price" => "invalid value" }}, valid_session
        assigns(:price).should be_a_new(Price)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested price" do
        ...
        Price.any_instance.should_receive(:update).with({ "price" => "9.99" })
        put :update, {:id => price.to_param, :price => { "price" => "9.99" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the price as @price" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Price.any_instance.stub(:save).and_return(false)
        put :update, {:id => price.to_param, :price => { "price" => "invalid value" }}, valid_session
        assigns(:price).should eq(price)
      end
